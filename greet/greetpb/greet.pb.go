...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x52, 0x0b, 0x6c, 0x61, 0x72, 0x67, 0x65, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x32, 0x9f, 0x02,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x54, 0x0a, 0x0e, 0x47, 0x72, 0x65, 0x65, 0x74,
	...
	0x01, 0x12, 0x3c, 0x0a, 0x07, 0x42, 0x69, 0x47, 0x72, 0x65, 0x65, 0x74, 0x12, 0x15, 0x2e, 0x67,
	0x72, 0x65, 0x65, 0x74, 0x2e, 0x42, 0x69, 0x47, 0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x42, 0x69, 0x47, 0x72,
...
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	...
	8, // 9: greet.GreetService.BiGreet:output_type -> greet.BiGreetResponse
...
type GreetService_BiGreetClient interface {
	...
	CloseAndRecv() (*BiGreetResponse, error)
	grpc.ClientStream
}
...
func (x *greetServiceBiGreetClient) CloseAndRecv() (*BiGreetResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
...
type GreetService_BiGreetServer interface {
	SendAndClose(*BiGreetResponse) error
...
func (x *greetServiceBiGreetServer) SendAndClose(m *BiGreetResponse) error {
	return x.ServerStream.SendMsg(m)
}
